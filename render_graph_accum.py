...
def render_graph_DefaultRenderGraph():
    ...
    g.addEdge('GBufferRaster.posW', 'ReSTIRPass.posW')
    g.addEdge('GBufferRaster.normW', 'ReSTIRPass.normalW')
    g.addEdge('GBufferRaster.faceNormalW', 'ReSTIRPass.faceNormalW')
    g.addEdge('GBufferRaster.diffuseOpacity', 'ReSTIRPass.mtlDiffOpacity')
    g.addEdge('GBufferRaster.specRough', 'ReSTIRPass.mtlSpecRough')
    g.addEdge('GBufferRaster.emissive', 'ReSTIRPass.mtlEmissive')
    g.addEdge('GBufferRaster.matlExtra', 'ReSTIRPass.mtlParams')
